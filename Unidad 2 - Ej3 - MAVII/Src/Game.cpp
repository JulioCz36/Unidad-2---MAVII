...
void Game::InitPhysics()
{
    ...
    // Crear obstaculos
    b2Body* obstaculo1Body = Box2DHelper::CreateRectangularStaticBody(phyWorld, 20, 5);
    obstaculo1Body->SetTransform(b2Vec2(50.0f, 20.0f), 45.0f);

    b2Body* obstaculo2Body = Box2DHelper::CreateRectangularStaticBody(phyWorld, 10, 5);
    obstaculo2Body->SetTransform(b2Vec2(20.0f, 80.0f), -45.0f);

    b2Body* obstaculo3Body = Box2DHelper::CreateRectangularStaticBody(phyWorld, 10, 5);
    obstaculo3Body->SetTransform(b2Vec2(70.0f, 80.0f), -45.0f);
